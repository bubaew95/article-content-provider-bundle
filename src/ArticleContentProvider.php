...
use CarCasCarSkillboxSymfony\ArticleContentProviderBundle\Event\OnBeforeWordPasteEvent;
...
class ArticleContentProvider
{
    ...
    private function paste(string $text, string $word, int $wordsCount = 1): string
    {
        ...
        for ($i = 0; $i < $wordsCount; $i++) {
            ...
            array_splice($words, $position, 0, $this->wordDecorator->decorator($event->getWord(), $this->isBold));
        }
